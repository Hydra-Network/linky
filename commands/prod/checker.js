module.exports = {
  check: async (url) => {
    ...
    const list = await fetch(
      `http://40.160.3.200:8000/api?link=${url}&blocker=aristotle,blocksi,cisco,contentkeeper,deledao,fortiguard,goguardian,iboss,lanschool,lightspeed,linewize,paloalto,securly,senso`,
    ).then(res => res.json());
